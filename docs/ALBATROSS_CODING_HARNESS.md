...
- completes output-redaction preparation before launch, launches agent commands under Linux subreaper supervision and post-run validation inside a Bubblewrap filesystem/network sandbox, terminates their complete adopted descendant trees even on operator interruption, and then collects final evidence;
