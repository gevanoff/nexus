...
ns_ensure_media_runtime_dirs() {
  ...
  ns_mkdir_p "${runtime_root}/ltx-video/app"
  ns_mkdir_p "${runtime_root}/ltx-video/models"
  ns_mkdir_p "${runtime_root}/ltx-video/outputs"
  ns_mkdir_p "${runtime_root}/ltx-video/cache"
  ns_mkdir_p "${runtime_root}/hunyuan-video/app"
  ns_mkdir_p "${runtime_root}/hunyuan-video/models"
  ns_mkdir_p "${runtime_root}/hunyuan-video/outputs"
  ns_mkdir_p "${runtime_root}/hunyuan-video/cache"
  ns_mkdir_p "${runtime_root}/ace-step/app"
  ns_mkdir_p "${runtime_root}/ace-step/models"
  ns_mkdir_p "${runtime_root}/ace-step/outputs"
  ns_mkdir_p "${runtime_root}/ace-step/cache"
...
ns_resolve_docker_env_file() {
  ...
  # Physical and logical paths are the same.  Check if the path is outside any
  # Colima-mounted directory by looking for a writable local runtime dir.
  ...
  # Last resort: return the physical/logical path as-is
  printf '%s\n' "$env_file"
}
