...
class Settings(BaseSettings):
    ...
    MODEL_TOOL_QUALIFICATION_AUTO_RUN_MODELS: str = "mlx,default,reasoning,fast-reasoning,fast"
    ...
    MLX_HUGE_LANE_DEFAULT_MODEL: str = "mlx-community/GLM-5.2-4bit"
    ...
    NEXUS_SENTINEL_DOCKER_IMAGE_PRUNE_ENABLED: bool = True
    NEXUS_SENTINEL_DOCKER_IMAGE_PRUNE_HOSTS: str = "stackrot,ada2"
    NEXUS_SENTINEL_DOCKER_IMAGE_PRUNE_COOLDOWN_SEC: int = 86_400
    ...
    CODING_AGENT_MAX_CYCLES_PER_RUN: int = 1000
    CODING_AGENT_MAX_RUNTIME_SEC: int = 21_600
    CODING_AGENT_CONTEXT_RESET_CYCLES: int = 0
    CODING_AGENT_CONTEXT_RESET_CHARS: int = 64_000
    CODING_AGENT_AUTO_RESUME_INTERRUPTED: bool = True
