...
def _run_coroutine_sync(coro: Any) -> Any:
    ...
    # If we're on the event loop thread, run_coroutine_threadsafe + result()
    # would deadlock (blocks the loop that must execute the coroutine).
    # Fall back to spawning a new thread with a fresh event loop.
