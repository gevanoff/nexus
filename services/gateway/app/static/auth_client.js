(function () {
  ...
  const TITLE_BY_ID = {
    ...
    saveVoice: 'Save the current uploaded or recorded sample as a reusable cloned voice.',
    ...
    settings_use_browser_api_key: 'Validate and save a pasted personal API key in this browser.',
    ...
    settings_user_llm_enabled: 'Allow saved commercial LLM API-key models to appear in model selectors.',
    settings_user_llm_openai_key: 'Set or replace your OpenAI API key.',
    settings_user_llm_openrouter_key: 'Set or replace your OpenRouter API key.',
    settings_user_llm_custom_openai_key: 'Set or replace the API key for a custom OpenAI-compatible endpoint.',
    settings_user_llm_openai_load_models: 'Load available OpenAI model IDs using the key and base URL in Settings.',
    settings_user_llm_openrouter_load_models: 'Load available OpenRouter model IDs using the key and base URL in Settings.',
    settings_user_llm_custom_openai_load_models: 'Load available model IDs from the custom OpenAI-compatible endpoint.',
    ...
    createAndRun: 'Create a workspace and start the coding agent.',
    agentRun: 'Start the autonomous coding agent for the selected workspace.',
    agentStop: 'Pause the current autonomous coding run.',
  ...
  const INPUT_TO_ACTION = {
    ...
    settings_browser_api_key: 'settings_use_browser_api_key',
    settings_profile_tone: 'settings_save',
    settings_coding_git_token: 'settings_save',
    settings_user_llm_openai_key: 'settings_save',
    settings_user_llm_openrouter_key: 'settings_save',
    settings_user_llm_custom_openai_key: 'settings_save',
    settings_user_llm_openai_base_url: 'settings_user_llm_openai_load_models',
    settings_user_llm_openrouter_base_url: 'settings_user_llm_openrouter_load_models',
    settings_user_llm_custom_openai_base_url: 'settings_user_llm_custom_openai_load_models',
