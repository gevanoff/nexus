  ...
  function mergeBackendStatusPayload(lifecyclePayload, registryPayload) {
    ...
    registryBackends.forEach((backend) => {
      ...
      merged.set(key, {
        ...
        host: backend.deployment_host || existing.deployment_host || existing.host || existing.hostname || backend.hostname || backend.host,
