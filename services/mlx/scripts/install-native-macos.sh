...
MLX_MODEL_PATH="${MLX_MODEL_PATH:-mlx-community/Qwen2.5-32B-Instruct-4bit}"
...
Options:
  --model-path PATH   Model path/repo id (default: mlx-community/Qwen2.5-32B-Instruct-4bit)
